...
var doVecAdd = async(function*() {
    ...
    for (var i = 0; i < n; i ++) {
        ...
        double.set(h_a, offset, 1 / (4 * i + 1));
        double.set(h_b, offset, - 1 / (4 * i + 3));
    }
    ...
    var kernelSourceCode = fs.readFileSync(path.join(cwd, "test_vector_addition.cl"), { encoding: "utf8" });
    var program = context.createProgram(kernelSourceCode);

    console.log("Building test_vector_addition.cl...");
    ...
    console.log("Final result: " + sum * 4    );
});
