...
\title[\insertlecture]{\hspace{-1.3cm} {\raisebox{-0.7cm}[0cm][0cm]{ \includegraphics[height =1.2cm]{../../html/fabcoin.png}}}~~~~Request for new foundation chain opcode~~~~~~~}
...
\lect{\today}{Proposal}{1}{
\include{presentation-content-2018-10-12}
}
